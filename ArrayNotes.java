...
public class ArrayNotes
{
    ...
    public static void createArrayOfCalendars()
    {
         ...
         *      of each month.
         *      
         *  When we create an array of objects, each element is initialized to null.
         *      We have to explicitly create *new* objects and assign to each element.
         */
         ...
         *      (e.g., references to calendars), but we can call mutator methods which
         *      modify the properties of the referenced objects (e.g., day of the month).
         */
        for(GregorianCalendar calendar : calendars)
        {
